...
class ClusterCephFlagsSetFlagsAction(ProxmoxAction):
    ...
    def run(self, nobackfill=None, nodeep_scrub=None, nodown=None, noin=None, noout=None, norebalance=None, norecover=None, noscrub=None, notieragent=None, noup=None, pause=None, profile_name=None):
