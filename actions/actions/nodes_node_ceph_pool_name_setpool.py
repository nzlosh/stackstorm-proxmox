...
class NodesNodeCephPoolNameSetpoolAction(ProxmoxAction):
    """
    Change POOL settings
    """

    def run(self, name, node, application=None, crush_rule=None, min_size=None, pg_autoscale_mode=None, pg_num=None, pg_num_min=None, size=None, target_size=None, target_size_ratio=None, profile_name=None):
