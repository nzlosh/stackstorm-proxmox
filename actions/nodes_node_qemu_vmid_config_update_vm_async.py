...
class NodesNodeQemuVmidConfigUpdateVmAsyncAction(ProxmoxAction):
    ...
    def run(self, node, vmid, acpi=None, agent=None, arch=None, args=None, audio0=None, autostart=None, background_delay=None, balloon=None, bios=None, boot=None, bootdisk=None, cdrom=None, cicustom=None, cipassword=None, citype=None, ciuser=None, cores=None, cpu=None, cpulimit=None, cpuunits=None, delete=None, description=None, digest=None, efidisk0=None, force=None, freeze=None, hookscript=None, hostpci_list=None, hotplug=None, hugepages=None, ide_list=None, ipconfig_list=None, ivshmem=None, keyboard=None, kvm=None, localtime=None, lock=None, machine=None, memory=None, migrate_downtime=None, migrate_speed=None, name=None, nameserver=None, net_list=None, numa=None, numa_list=None, onboot=None, ostype=None, parallel_list=None, protection=None, reboot=None, revert=None, sata_list=None, scsi_list=None, scsihw=None, searchdomain=None, serial_list=None, shares=None, skiplock=None, smbios1=None, smp=None, sockets=None, spice_enhancements=None, sshkeys=None, startdate=None, startup=None, tablet=None, tags=None, tdf=None, template=None, unused_list=None, usb_list=None, vcpus=None, vga=None, virtio_list=None, vmgenid=None, vmstatestorage=None, watchdog=None, profile_name=None):
