...
class ClusterJobsScheduleAnalyzeScheduleAnalyzeAction(ProxmoxAction):
    ...
    def run(self, schedule, iterations=None, starttime=None, profile_name=None, api_timeout=5):
        ...
        return self.proxmox.get(f"cluster/jobs/schedule-analyze", **proxmox_kwargs)
