...
class NodesNodeCephPoolsCreatepoolAction(ProxmoxAction):
    ...
    def run(self, name, node, add_storages=None, application="rbd", crush_rule=None, min_size=2, pg_autoscale_mode="warn", pg_num=128, pg_num_min=None, size=3, target_size=None, target_size_ratio=None, profile_name=None):
