...
class StorageCreateAction(ProxmoxAction):
    ...
    def run(self, storage, prox_type, authsupported=None, base=None, blocksize=None, bwlimit=None, comstar_hg=None, comstar_tg=None, content=None, datastore=None, disable=None, domain=None, encryption_key=None, export=None, fingerprint=None, prox_format=None, fuse=None, is_mountpoint="no", iscsiprovider=None, krbd=None, lio_tpg=None, master_pubkey=None, maxfiles=None, mkdir=True, monhost=None, mountpoint=None, namespace=None, nodes=None, nowritecache=None, options=None, password=None, path=None, pool=None, port=8007, portal=None, prune_backups=None, redundancy=2, saferemove=None, saferemove_throughput=None, server=None, server2=None, share=None, shared=None, smbversion=None, sparse=None, subdir=None, tagged_only=None, target=None, thinpool=None, transport=None, username=None, vgname=None, volume=None, profile_name=None):
