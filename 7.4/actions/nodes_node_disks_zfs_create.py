...
class NodesNodeDisksZfsCreateAction(ProxmoxAction):
    ...
    def run(self, devices, name, node, raidlevel, add_storage=None, ashift=None, compression=None, draid_config=None, profile_name=None):
        ...
        for api_arg in [
            ...
            ["draid-config", draid_config, "string"],
            ["name", name, "string"],
            ["node", node, "string"],
