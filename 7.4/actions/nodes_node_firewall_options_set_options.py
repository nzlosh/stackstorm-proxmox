...
class NodesNodeFirewallOptionsSetOptionsAction(ProxmoxAction):
    ...
    def run(self, node, delete=None, digest=None, enable=None, log_level_in=None, log_level_out=None, log_nf_conntrack=None, ndp=None, nf_conntrack_allow_invalid=None, nf_conntrack_helpers=None, nf_conntrack_max=None, nf_conntrack_tcp_timeout_established=None, nf_conntrack_tcp_timeout_syn_recv=None, nosmurfs=None, protection_synflood=None, protection_synflood_burst=None, protection_synflood_rate=None, smurf_log_level=None, tcp_flags_log_level=None, tcpflags=None, profile_name=None):
        ...
        for api_arg in [
            ...
            ["nf_conntrack_helpers", nf_conntrack_helpers, "string"],
