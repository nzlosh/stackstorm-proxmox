...
class NodesNodeQemuVmidStatusStartVmStartAction(ProxmoxAction):
    ...
    def run(self, node, vmid, force_cpu=None, machine=None, migratedfrom=None, migration_network=None, migration_type=None, skiplock=None, stateuri=None, targetstorage=None, timeout=10, profile_name=None):
