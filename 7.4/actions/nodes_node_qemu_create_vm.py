...
class NodesNodeQemuCreateVmAction(ProxmoxAction):
    ...
    def run(self, node, vmid, acpi=True, affinity=None, agent=None, arch=None, archive=None, args=None, audio0=None, autostart=False, balloon=None, bios="seabios", boot=None, bootdisk=None, bwlimit=0, cdrom=None, cicustom=None, cipassword=None, citype=None, ciuser=None, cores=1, cpu=None, cpulimit=0, cpuunits=100, description=None, efidisk0=None, force=None, freeze=None, hookscript=None, hostpci_list=None, hotplug="network,disk,usb", hugepages=None, ide_list=None, ipconfig_list=None, ivshmem=None, keephugepages=False, keyboard="en-us", kvm=True, live_restore=None, localtime=None, lock=None, machine=None, memory=512, migrate_downtime=0.1, migrate_speed=0, name=None, nameserver=None, net_list=None, numa=False, numa_list=None, onboot=False, ostype=None, parallel_list=None, pool=None, protection=False, reboot=True, rng0=None, sata_list=None, scsi_list=None, scsihw="lsi", searchdomain=None, serial_list=None, shares=1000, smbios1=None, smp=1, sockets=1, spice_enhancements=None, sshkeys=None, start=False, startdate="now", startup=None, storage=None, tablet=True, tags=None, tdf=False, template=False, tpmstate0=None, unique=None, unused_list=None, usb_list=None, vcpus=1, vga=None, virtio_list=None, vmgenid="1", vmstatestorage=None, watchdog=None, profile_name=None):
