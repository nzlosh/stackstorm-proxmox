...
class NodesNodeQemuVmidMove_diskMoveVmDiskAction(ProxmoxAction):
    ...
    def run(self, disk, node, vmid, bwlimit=0, delete=False, digest=None, prox_format=None, storage=None, target_digest=None, target_disk=None, target_vmid=None, profile_name=None):
