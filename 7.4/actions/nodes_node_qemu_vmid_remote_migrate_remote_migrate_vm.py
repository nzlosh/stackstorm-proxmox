...
class NodesNodeQemuVmidRemote_migrateRemoteMigrateVmAction(ProxmoxAction):
    ...
    def run(self, node, target_bridge, target_endpoint, target_storage, vmid, bwlimit=migrate limit from datacenter or storage config, delete=False, online=None, target_vmid=None, profile_name=None):
