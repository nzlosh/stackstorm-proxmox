...
class NodesNodeQemuVmidStatusStartVmStartAction(ProxmoxAction):
    ...
    def run(self, node, vmid, machine=None, migratedfrom=None, migration_network=None, migration_type=None, skiplock=None, stateuri=None, targetstorage=None, profile_name=None):
