...
class NodesNodeLxcVmidConfigUpdateVmAction(ProxmoxAction):
    ...
    def run(self, node, vmid, arch="amd64", cmode="tty", console=True, cores=None, cpulimit=0, cpuunits=1024, delete=None, description=None, digest=None, features=None, hookscript=None, hostname=None, lock=None, memory=512, mp_list=None, nameserver=None, net_list=None, onboot=False, ostype=None, protection=False, revert=None, rootfs=None, searchdomain=None, startup=None, swap=512, tags=None, template=False, tty=2, unprivileged=False, unused_list=None, profile_name=None):
