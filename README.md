...
| Parameter | Type | Required | Secret | Description |
|---|---|---|---|---|
| `command` | string | True | default | _The command as a list of program + arguments_ |
| `node` | string | True | default | _The cluster node name._ |
...
_Get current virtual machine configuration. This does not include pending configuration changes (see 'pending' API)._
...
_Generate new cluster configuration._

| Parameter | Type | Required | Secret | Description |
|---|---|---|---|---|
| `clustername` | string | True | default | _The name of the cluster._ |
| `link_list` | string | False | default | _Address and priority information of a single corosync link._ |
...
| `mp_list` | string | False | default | _Use volume as container mount point._ |
...
| `schedule` | string | False | default | _Storage replication schedule. The format is a subset of `systemd` calender events._ |
| `source` | string | False | default | _Source of the replication._ |
...
| `password` | string | False | True | _Password for CIFS share._ |
...
| `realm` | string | True | default | _Authentication domain ID_ |
| `secure` | boolean | False | default | _Use secure LDAPS protocol._ |
...
| `application` | string | False | default | _The application of the pool, 'rbd' by default._ |
...
| `exclude_path` | string | False | default | _Exclude certain files/directories (shell globs)._ |
| `prox_id` | string | True | default | _The job ID._ |
...
| `mailto` | string | False | default | _Comma-separated list of email addresses that should receive email notifications._ |
...
| `profile_name` | string | False | default | _The profile to use to run the action._ |
### cluster_config_join
_Joins this node into an existing cluster._
...
_Destroy the vm (also delete all used/owned volumes)._

| Parameter | Type | Required | Secret | Description |
|---|---|---|---|---|
| `node` | string | True | default | _The cluster node name._ |
| `purge` | boolean | False | default | _Remove vmid from backup cron jobs._ |
| `skiplock` | boolean | False | default | _Ignore locks - only root is allowed to use this option._ |
| `vmid` | integer | True | default | _The (unique) ID of the VM._ |
| `profile_name` | string | False | default | _The profile to use to run the action._ |
...
| `archive` | string | False | default | _The backup file._ |
...
| `boot` | string | False | default | _Boot on floppy (a), hard disk (c), CD-ROM (d), or network (n)._ |
| `bootdisk` | string | False | default | _Enable booting from specified disk._ |
...
| `efidisk0` | string | False | default | _Configure a Disk for storing EFI vars_ |
...
| `ide_list` | string | False | default | _Use volume as IDE hard disk or CD-ROM (n is 0 to 3)._ |
| `ipconfig_list` | string | False | default | _cloud-init: Specify IP addresses and gateways for the corresponding interface.  IP addresses use CIDR notation, gateways are optional but need an IP of the same type specified.  The special string 'dhcp' can be used for IP addresses to use DHCP, in which case no explicit gateway should be provided. For IPv6 the special string 'auto' can be used to use stateless autoconfiguration.  If cloud-init is enabled and neither an IPv4 nor an IPv6 address is specified, it defaults to using dhcp on IPv4. _ |
...
| `sata_list` | string | False | default | _Use volume as SATA hard disk or CD-ROM (n is 0 to 5)._ |
| `scsi_list` | string | False | default | _Use volume as SCSI hard disk or CD-ROM (n is 0 to 13)._ |
...
| `virtio_list` | string | False | default | _Use volume as VIRTIO hard disk (n is 0 to 15)._ |
...
_Get virtual machine configuration, including pending changes._
...
| `targetstorage` | string | False | default | _Target storage for the migration. (Can be '1' to use the same storage id as on the source node.)_ |
| `vmid` | integer | True | default | _The (unique) ID of the VM._ |
| `profile_name` | string | False | default | _The profile to use to run the action._ |
...
| `target` | string | True | default | _Target node._ |
| `targetstorage` | string | False | default | _Default target storage._ |
| `vmid` | integer | True | default | _The (unique) ID of the VM._ |
