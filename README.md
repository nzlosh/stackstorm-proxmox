...
| `digest` | string | False | default | _Prevent changes if current configuration file has different SHA1 digest. This can be used to prevent concurrent modifications._ |
| `gateway_external_peers` | string | False | default | _upstream bgp peers address list._ |
| `gateway_nodes` | string | False | default | _List of cluster node names._ |
| `peers` | string | False | default | _peers address list._ |
| `profile_name` | string | False | default | _The profile to use to run the action._ |
...
| `ipv4` | string | False | default | _Anycast router ipv4 address._ |
| `ipv6` | string | False | default | _Anycast router ipv6 address._ |
| `mac` | string | False | default | _Anycast router mac address_ |
...
| `scsi_list` | string | False | default | _Use volume as SCSI hard disk or CD-ROM (n is 0 to 30)._ |
