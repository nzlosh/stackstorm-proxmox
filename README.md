...
local filesystem or via the Proxmox web interface.  The pack was originally developed against
Proxmox v7.0 but might work with other versions of Proxmox API documentation.

The actions describes on this README are generated using the the folder 7.4. The arguments may vary between the versions.
...
| Parameter | Type | Required | Secret | Description |
|---|---|---|---|---|
| `new_format` | boolean | False | default | _With webauthn the format of half-authenticated tickts changed. New clients should pass 1 here and not worry about the old format. The old format is deprecated and will be retired with PVE-8.0_ |
...
_List pool settings. Deprecated, please use `/nodes/{node}/ceph/pool/{pool}/status`._
...
_Destroy pool. Deprecated, please use `/nodes/{node}/ceph/pool/{name}`._
...
_Change POOL settings. Deprecated, please use `/nodes/{node}/ceph/pool/{name}`._
...
_List all pools. Deprecated, please use `/nodes/{node}/ceph/pool`._
...
_Get the Ceph configuration database. Deprecated, please use `/nodes/{node}/ceph/cfg/db._
...
_Create Ceph pool. Deprecated, please use `/nodes/{node}/ceph/pool`._
...
_Get the Ceph configuration file. Deprecated, please use `/nodes/{node}/ceph/cfg/raw._
