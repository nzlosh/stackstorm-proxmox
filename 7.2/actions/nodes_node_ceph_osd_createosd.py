...
class NodesNodeCephOsdCreateosdAction(ProxmoxAction):
    ...
    def run(self, dev, node, crush_device_class=None, db_dev=None, db_dev_size=bluestore_block_db_size or 10% of OSD size, encrypted=False, wal_dev=None, wal_dev_size=bluestore_block_wal_size or 1% of OSD size, profile_name=None):
