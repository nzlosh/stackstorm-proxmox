...
class StorageCreateAction(ProxmoxAction):
    ...
    def run(self, storage, prox_type, authsupported=None, base=None, blocksize=None, bwlimit=None, comstar_hg=None, comstar_tg=None, content=None, data_pool=None, datastore=None, disable=None, domain=None, encryption_key=None, export=None, fingerprint=None, prox_format=None, fs_name=None, fuse=None, is_mountpoint="no", iscsiprovider=None, keyring=None, krbd=None, lio_tpg=None, master_pubkey=None, max_protected_backups=Unlimited for users with Datastore.Allocate privilege, 5 for other users, maxfiles=None, mkdir=True, monhost=None, mountpoint=None, namespace=None, nocow=False, nodes=None, nowritecache=None, options=None, password=None, path=None, pool=None, port=8007, portal=None, preallocation="metadata", prune_backups=None, saferemove=None, saferemove_throughput=None, server=None, server2=None, share=None, shared=None, smbversion="default", sparse=None, subdir=None, tagged_only=None, target=None, thinpool=None, transport=None, username=None, vgname=None, volume=None, profile_name=None):
