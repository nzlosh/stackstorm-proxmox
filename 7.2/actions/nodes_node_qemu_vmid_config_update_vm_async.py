...
class NodesNodeQemuVmidConfigUpdateVmAsyncAction(ProxmoxAction):
    ...
    def run(self, node, vmid, acpi=True, agent=None, arch=None, args=None, audio0=None, autostart=False, background_delay=None, balloon=None, bios="seabios", boot=None, bootdisk=None, cdrom=None, cicustom=None, cipassword=None, citype=None, ciuser=None, cores=1, cpu=None, cpulimit=0, cpuunits=cgroup v1: 1024, cgroup v2: 100, delete=None, description=None, digest=None, efidisk0=None, force=None, freeze=None, hookscript=None, hostpci_list=None, hotplug="network,disk,usb", hugepages=None, ide_list=None, ipconfig_list=None, ivshmem=None, keephugepages=False, keyboard=null, kvm=True, localtime=None, lock=None, machine=None, memory=512, migrate_downtime=0.1, migrate_speed=0, name=None, nameserver=None, net_list=None, numa=False, numa_list=None, onboot=False, ostype=None, parallel_list=None, protection=False, reboot=True, revert=None, rng0=None, sata_list=None, scsi_list=None, scsihw="lsi", searchdomain=None, serial_list=None, shares=1000, skiplock=None, smbios1=None, smp=1, sockets=1, spice_enhancements=None, sshkeys=None, startdate="now", startup=None, tablet=True, tags=None, tdf=False, template=False, tpmstate0=None, unused_list=None, usb_list=None, vcpus=0, vga=None, virtio_list=None, vmgenid="1 (autogenerated)", vmstatestorage=None, watchdog=None, profile_name=None):
